...
# export PYSPARK_DRIVER_PYTHON=/opt/pyenv/versions/3.6.12/bin/ipython
export SPARK_LOCAL_IP=$HOSTNAME

export SPARK_LOCAL_DIRS=/home/dataengineer/tmp/spark
export SPARK_PID_DIR=/home/dataengineer/tmp/spark/pid
export SPARK_WORKER_DIR=/home/dataengineer/tmp/spark/work
